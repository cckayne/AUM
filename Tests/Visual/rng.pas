...
// all rngs
type TRNG = (CONG,COSWB,ISAAC,B128,B256,B512,MOT8,MOT16,MOT32,MOT64,OM,KILFI,KISS,KISWB,LFIB4,MWC,MWSWB,SHR3,SHRSW,SWB); 
	 TRNGarray = array[CONG..SWB] of string;

const RNGs: TRNGarray = ('CONG','COSWB','ISAAC','BB128','BB256','BB512','MOTE8','MOTE16','MOTE32','MOTE64','AUM','KILFI','KISS','KISWB','LFIB4','MWC','MWSWB','SHR3','SHRSW','SWB'); 
...
uses sysutils, myisaac, marsaglia, bb128, bb256, bb512, mote8, mote16, mote32, mote64, aum;
